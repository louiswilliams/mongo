...
std::unique_ptr<Collection> CollectionFactoryImpl::create(
    OperationContext* opCtx,
    CollectionCatalogEntry* collectionCatalogEntry,
    const NamespaceString& nss) const {

    auto rs = collectionCatalogEntry->getRecordStore();
    auto uuid = collectionCatalogEntry->getCollectionOptions(opCtx).uuid;
    invariant(rs,
...
std::unique_ptr<Collection> CollectionFactoryImpl::createForRepair(
    OperationContext* opCtx,
    CollectionCatalogEntry* collectionCatalogEntry,
    const NamespaceString& nss) const {
