...
public:
    ...
    class BulkBuilder {
    public:
        using Sorter = mongo::Sorter<KeyString::Value, NullValue>;
    ...
    virtual Status commitBulk(OperationContext* opCtx,
                              ...
                              std::vector<KeyString::Value>* dupKeys) = 0;
...
public:
    ...
    std::vector<KeyString::Value> dupsInserted;
};
...
public:
    ...
    Status commitBulk(OperationContext* opCtx,
                      ...
                      bool dupsAllowed,
                      std::set<RecordId>* dupRecords,
                      std::vector<KeyString::Value>* dupKeys) final;
